...
class FirstViewController: UIViewController {
    ...
    let upsellItems = ["notification:Get snow delay alerts", "notification:Get urgent school updates", "feedback:Give feedback", "theme:Unlock Dark Theme"];
    ...
    override func viewDidLoad() {
        ...
        NSTimer.scheduledTimerWithTimeInterval(12.0, target: self, selector: #selector(FirstViewController.nextButton), userInfo: nil, repeats: true)
    }
    ...
    func nextButton() {
        ...
        repeat {
            ...
            if(UpgradeManager.sharedInstance.proEnabled() || !UpgradeManager.sharedInstance.ready()) {
                if(upsellItems[upsellButtonIndex].componentsSeparatedByString(":")[0] == "theme") {
                    ok = false;
                }
            }
    ...
    @IBAction func upsellButton(sender: AnyObject) {
        ...
        } else if(upsellItems[upsellButtonIndex].hasPrefix("theme:")) {
